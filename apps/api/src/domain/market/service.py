...
class MarketService:
    ...
    async def get_region_price_overview(self, months: int = 3) -> RegionPriceOverviewResponse:
        """지역별 가격 변동 개요 조회"""
        overview_data = await self.repository.get_region_price_overview(months=months)
